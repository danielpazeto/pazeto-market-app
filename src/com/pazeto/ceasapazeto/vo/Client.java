...
public class Client extends BaseDB implements Serializable {
    ...
    public static final String CREATE_TABLE_CLIENTE = "CREATE TABLE IF NOT EXISTS "+ TABLE_NAME + "( "+
    ...
    public  static final String DROP_TABLE_CLIENTE = "DROP TABLE IF EXISTS "+TABLE_NAME;
